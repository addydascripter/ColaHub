...
local key = "cola"
local discordLink = "https://discord.gg/t9JavVwcdK"
local scriptToLoad = [[
local Players = game:GetService("Players")
local RunService = game:GetService("RunService")
local TweenService = game:GetService("TweenService")
...
local function DeliverBrainrot(statusLabel)
    ...
    if not hitbox then
        ...
        statusLabel.TextColor3 = Color3.fromRGB(255, 2, 1)
    ...
    if distance <= 30 then
        ...
        statusLabel.Text = "Teleport Failed: Try again (" .. math.floor(distance) .. ")"
        statusLabel.TextColor3 = Color3.fromRGB(255, 2, 1)
    end
    TweenService:Create(statusLabel, TweenInfo.new(0.3), {TextTransparency = 0}):Play()
    task.wait(2)
...
local function TweenSteal(statusLabel)
    ...
    if distance <= 30 then
        ...
        statusLabel.Text = "TweenSteal Failed: Try again (" .. math.floor(distance) .. ")"
        statusLabel.TextColor3 = Color3.fromRGB(255, 2, 1)
    end
    TweenService:Create(statusLabel, TweenInfo.new(0.3), {TextTransparency = 0}):Play()
    task.wait(2)
...
CloseButton.Text = "X"
CloseButton.TextColor3 = Color3.fromRGB(255, 2, 1)
...
DeliveryButton.BackgroundColor3 = Color3.fromRGB(149, 0, 220)
...
DeliveryButton.Text = "AUTO STEAL (SPAM UNTIL WORKS)"
...
DeliveryStroke.Color = Color3.fromRGB(0, 0, 0)
...
BaseButton.BackgroundColor3 = Color3.fromRGB(149, 0, 220)
...
BaseButton.Text = "GLITCH INSIDE NEAREST BASE"
...
TweenStealButton.BackgroundColor3 = Color3.fromRGB(149, 0, 220)
...
TweenStealButton.Text = "TWEEN TO BASE"
...
TweenStealStroke.Color = Color3.fromRGB(0, 0, 0)
...
local function createHoverEffect(button, stroke)
    ...
    button.MouseLeave:Connect(function()
        TweenService:Create(button, TweenInfo.new(0.2, Enum.EasingStyle.Exponential), {
            BackgroundColor3 = Color3.fromRGB(149, 0, 220),
            TextColor3 = Color3.fromRGB(255, 255, 255)
        }):Play()
        TweenService:Create(stroke, TweenInfo.new(0.2, Enum.EasingStyle.Exponential), {
...
SubmitButton.BackgroundColor3 = Color3.fromRGB(149, 0, 220)
...
SubmitStroke.Color = Color3.fromRGB(0, 0, 0)
...
GetCodeButton.BackgroundColor3 = Color3.fromRGB(149, 0, 220)
...
GetCodeStroke.Color = Color3.fromRGB(0, 0, 0)
...
NotificationLabel.TextColor3 = Color3.fromRGB(255, 2, 1)
...
Circle1.BackgroundColor3 = Color3.fromRGB(149, 0, 220)
...
Circle2.BackgroundColor3 = Color3.fromRGB(149, 0, 220)
...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if userInput == key then
        ...
        InputBox.Text = ""
        TweenService:Create(InputStroke, TweenInfo.new(0.3), {Color = Color3.fromRGB(255, 2, 1)}):Play()
